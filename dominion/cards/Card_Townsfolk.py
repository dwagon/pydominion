#!/usr/bin/env python
"""https://wiki.dominionstrategy.com/index.php/Townsfolk"""
import unittest
...
class TownsfolkCardPile(CardPile.CardPile):
    ...
    def init_cards(self, num_cards=0, card_class=None):
        ...
        for card_klass in (Card_Town_Crier, Card_Blacksmith, Card_Miller, Card_Elder):
            for _ in range(4):
                self.cards.insert(0, card_klass())


###############################################################################
class TestTownsfolk(unittest.TestCase):
    """Test Townsfolk Pile"""
    ...
    def test_townsfolk(self):
        ...
        self.g.get_card_from_pile("Townsfolk")
        self.g.get_card_from_pile("Townsfolk")
        self.g.get_card_from_pile("Townsfolk")
        card = self.g.get_card_from_pile("Townsfolk")
