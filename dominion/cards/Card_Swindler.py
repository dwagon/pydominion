...
class Card_Swindler(Card.Card):
    ...
    def special(self, game: Game.Game, player: Player.Player) -> None:
        for victim in player.attack_victims():
            ...
            victim.output(f"{player}'s Swindler trashed your {trashed_card}")
            if gained_card := player.plr_gain_card(
                ...
                victim.output(
                    f"{player} picked a {gained_card} to replace your trashed {trashed_card}"
                )


###############################################################################
class TestSwindler(unittest.TestCase):
    """Test Swindler"""
