...
class Test_Advance(unittest.TestCase):
    def setUp(self):
        self.g = Game.Game(quiet=True, numplayers=1, eventcards=['Advance'], initcards=['Moat', 'Scout'])
        self.g.start_game()
    ...
    def test_advance(self):
        ...
        self.plr.test_input = ['moat', 'Scout']
        self.plr.performEvent(self.card)
        self.assertIsNone(self.plr.in_hand('Moat'))
        self.assertIsNotNone(self.plr.in_discard('Scout'))
