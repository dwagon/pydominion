...
class Test_Traits(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.g = Game.TestGame(numplayers=1, initcards=["TestTrait", "Moat", "Militia"], trait_path="tests/traits")
        self.g.start_game()
    ...
    def test_description(self) -> None:
        ...
        self.assertIn("TestTrait", militia.description(self.g.player_list()[0]))
